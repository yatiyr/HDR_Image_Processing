#include <Precomp.h>
#include <HDR_IP/System/WindowSystem/GlfwWindow.h>
...
namespace HDR_IP
{
	...
	{
		HDR_IP_ERROR("GLFW Error ({0}): {1}", error, description)
	}
	...
	void GlfwWindow::Init(const WinProperties& props)
	{
		...
		HDR_IP_INFO("Window is being created {0} ({1}, {2})", props.Title, props.Width, props.Height)
